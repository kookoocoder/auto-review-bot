...
export function IconStore({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 9.75V19.5a.75.75 0 00.75.75h15a.75.75 0 00.75-.75V9.75M3.75 9.75L5.25 4.5h13.5l1.5 5.25M3.75 9.75h16.5M9 19.5v-6h6v6" />
    </svg>
  );
}
...
export function IconHeadset({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12a7.5 7.5 0 0115 0v2.25a2.25 2.25 0 01-2.25 2.25H15v-4.5h2.25M4.5 12v2.25A2.25 2.25 0 006.75 16.5H9v-4.5H6.75A2.25 2.25 0 004.5 14.25V12z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 19.5a3 3 0 01-3-3h6a3 3 0 01-3 3z" />
    </svg>
  );
}
...
export function IconLink({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m9.86-2.287a4.5 4.5 0 00-1.242-7.244l-4.5-4.5a4.5 4.5 0 00-6.364 6.364L4.343 5.657" />
    </svg>
  );
}
...
export function IconSave({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75v12.75H6.75V4.5h8.25L17.25 6.75z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 15.75h6M9 4.5v4.5h6V4.5" />
    </svg>
  );
}
...
export function IconInfo({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 11.25h.008v.008H11.25v-.008zM12 15.75v-3.75" />
...
export function IconStar({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 2.25l2.955 5.986 6.607.96-4.781 4.66 1.129 6.58L12 17.27l-5.91 3.166 1.129-6.58-4.781-4.66 6.607-.96L12 2.25z" />
    </svg>
  );
}
...
export function IconQr({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3.75h6v6h-6v-6zm10.5 0h6v6h-6v-6zm-10.5 10.5h6v6h-6v-6zm10.5 3h1.5v1.5H14.25v-1.5zm3 0h3v3h-3v-3zm-3 3h1.5V21H14.25v-1.5zm4.5 0H21V21h-1.5v-1.5z" />
    </svg>
  );
}
...
export function IconCoffee({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8 8h8v7a3 3 0 01-3 3h-2a3 3 0 01-3-3V8z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M16 9h1.5a2.5 2.5 0 010 5H16M7 19h10M9 5c0-.5.5-1.5 1.5-1.5S12 4.5 12 5M12 5c0-.5.5-1.5 1.5-1.5S15 4.5 15 5" />
    </svg>
  );
}
